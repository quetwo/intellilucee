...
public final class CFMLFormatDocument extends AnAction
{
    private static final String COMMAND = "cfmleditor.format";
    ...
    public void actionPerformed(@NotNull AnActionEvent event)
    {
        ...
        String encodedFilePath = PathUtils.fixURIForLSP(file.getUrl());
        ...
        for (LspClient client : clients)
        {
            ...
            ApplicationManager.getApplication().executeOnPooledThread(() ->
                client.sendRequestSync(LspClient.DEFAULT_REQUEST_TIMEOUT_MS, (LanguageServer server) -> server.getWorkspaceService().executeCommand(new ExecuteCommandParams(COMMAND, List.of(encodedFilePath))))
            );
            return;
        }
    }
