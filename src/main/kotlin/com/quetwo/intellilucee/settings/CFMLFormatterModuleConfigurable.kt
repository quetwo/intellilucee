...
class CFMLFormatterModuleConfigurable(private val module: Module) : BoundSearchableConfigurable("CFML Formatter", "settings.intellilucee.cfml.formatter.module")
{
    private val settings = CFMLFormatterModuleSettings.getInstance(module)
    ...
    override fun createPanel(): DialogPanel
    {
        return panel {
            group("Module Overrides") {
                row {
                    checkBox("Override application settings")
                        .bindSelected(settings.state::overrideApplicationSettings)
                }
                row {
